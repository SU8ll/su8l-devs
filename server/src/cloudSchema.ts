  ...
  groups: [
    ...
    },
    {
      ...
      fields: [
        ...
        { ...bool(false), key: 'minewar_prioritize_vein', label: 'Prioritize vein occupies while the +5000 ore bonus is ready' },
        { ...bool(false), key: 'minewar_no_cesares', label: 'Do not attack Cesares while fractured veins are live' },
        { ...num('Max Target Radius (tiles)', 50, 1, 200), key: 'minewar_max_radius' },
        { ...bool(true), key: 'talent_level_1', label: 'Level 1: Right branch' },
        { ...bool(true), key: 'talent_level_2', label: 'Level 2: Right branch' },
        { ...bool(false), key: 'talent_level_3', label: 'Level 3: Right branch' },
        { ...bool(false), key: 'talent_level_4', label: 'Level 4: Right branch' },
        { ...bool(true), key: 'talent_level_5', label: 'Level 5: Right branch' },
      ],
    },
    {
      id: 'alliance_defense',
      ...
      icon: '🏰',
      fields: [
        { ...bool(false), key: 'alliance_defense_enable', label: 'Auto-reinforce alliance members under attack' },
        { ...bool(true), key: 'alliance_defense_solo', label: 'Answer solo attacks' },
        { ...bool(true), key: 'alliance_defense_rallies', label: 'Answer rallies' },
        { ...num('Minimum attacker power', 0, 0), key: 'alliance_defense_min_power', description: '0 = answer every attack' },
        { ...num('Minimum seconds before impact', 60, 0), key: 'alliance_defense_min_seconds' },
        { ...num('Max simultaneous reinforcements', 2, 1, 10), key: 'alliance_defense_max_reinforcements' },
        { ...num('Heroes kept in city', 3, 0, 10), key: 'alliance_defense_heroes' },
        { ...num('Max troops per march', 0, 0), key: 'alliance_defense_max_troops', description: '0 = no limit (use march capacity)' },
        { ...num('Infantry count %', 60, 0, 100), key: 'alliance_defense_inf', unit: '%' },
        { ...num('Cavalry count %', 40, 0, 100), key: 'alliance_defense_cav', unit: '%' },
        { ...num('Ranged count %', 0, 0, 100), key: 'alliance_defense_arch', unit: '%', description: '0 = keep all archers home' },
      ],
    },
    {
      id: 'bear_group',
      ...
      fields: [
        ...
        { ...num('Arrows per donation', 100, 1), key: 'bear_arr_donate', description: '100 = one full tier jump' },
        { ...num('Keep arrows in reserve', 0, 0), key: 'bear_arr_reserve', description: 'never drop below this stock' },
        { ...bool(false), key: 'bear_arr_maxed', label: 'Keep donating when the trap is already maxed' },
      ],
    },
    {
      id: 'beast_group',
    ...
    },
    {
      ...
      fields: [
        ...
        { ...num('Heroes kept in city', 3, 0, 10), key: 'viking_heroes' },
        { ...num('Recall buffer (seconds)', 30, 0), key: 'viking_buffer' },
        { ...num('Max recall lead (seconds)', 1800, 0), key: 'viking_lead' },
        { ...num('Max troops per march', 0, 0), key: 'viking_max_troops', description: '0 = no limit (use march capacity)' },
        { ...num('Infantry count %', 50, 0, 100), key: 'viking_inf', unit: '%' },
        { ...num('Cavalry count %', 50, 0, 100), key: 'viking_cav', unit: '%' },
        { ...num('Ranged count %', 0, 0, 100), key: 'viking_arch', unit: '%', description: '0 = keep all archers home' },
        { ...bool(true), key: 'viking_buff_heroes', label: 'Lead with buff-carrying heroes' },
  ...
  groups: [
    {
      ...
      fields: [
        ...
        { ...num('March Slots', 4, 1, 6), key: 'gather_slots' },
        { ...bool(false), key: 'gather_use_all', label: 'Use every free march slot for gathering' },
        { ...bool(true), key: 'gather_keep_last', label: 'Keep the last march slot for priority actions' },
        { ...num('Tile Level Min', 8, 1, 8), key: 'gather_lvl' },
        { ...num('Tile Level Max', 8, 1, 8), key: 'gather_lvl_max' },
        {
          ...sel('Formation', 'Default', ['Default', 'InfantryFocus', 'CavalryFocus', 'ArcherFocus', 'Balanced']),
          key: 'gather_form',
        },
        { ...sel('Strategy', 'DeficitWeighted', ['DeficitWeighted', 'RoundRobin']), key: 'gather_strat' },
        { ...slider('Iron priority %', 100, 0, 100), key: 'gather_iron' },
        { ...num('Food Min (millions)', 0, 0), key: 'gather_food_min' },
        { ...num('Food Max (millions)', 0, 0), key: 'gather_food_max' },
        { ...num('Wood Min (millions)', 0, 0), key: 'gather_wood_min' },
        { ...num('Wood Max (millions)', 0, 0), key: 'gather_wood_max' },
        { ...num('Stone Min (millions)', 0, 0), key: 'gather_stone_min' },
        { ...num('Stone Max (millions)', 0, 0), key: 'gather_stone_max' },
        { ...num('Iron Min (millions)', 0, 0), key: 'gather_iron_min' },
        { ...num('Iron Max (millions)', 0, 0), key: 'gather_iron_max' },
        { ...bool(false), key: 'gather_tiles', label: 'Include Alliance Resource Tiles' },
        { ...bool(false), key: 'gather_hero', label: 'Gather without boost hero' },
      ],
    },
    {
      id: 'gather_boost',
      title: 'Gathering Speed Boost item',
      icon: '⚡',
      fields: [
        { ...bool(false), key: 'gather_boost', label: 'Activate boost item before gather' },
        {
          ...sel('Boost duration', 'Hours24', ['Hours8', 'Hours24']),
          key: 'gather_boost_duration',
        },
        { ...num('Gem cost', 600, 0), key: 'gather_boost_gem_cost', description: '600 gems (Hours24) / 250 gems (Hours8)' },
        { ...bool(true), key: 'gather_boost_auto_buy', label: 'Auto-buy with gems if backpack empty' },
      ],
    },
  ],
};
...
const CHASE_TARGET_OPTIONS = ['Tier 1 only', 'Highest reachable', 'Every tier'];

function burnFields(prefix: string): CloudFieldSchema[] {
  return [
    { ...bool(false), key: `${prefix}burn_resources`, label: 'Resources' },
    { ...bool(false), key: `${prefix}burn_construction`, label: 'Construction speedups' },
    { ...bool(false), key: `${prefix}burn_research`, label: 'Research speedups' },
    { ...bool(false), key: `${prefix}burn_training`, label: 'Training speedups' },
    { ...bool(false), key: `${prefix}burn_stamina`, label: 'Stamina' },
    { ...bool(false), key: `${prefix}burn_shards_rare`, label: 'Hero shards (rare)' },
    { ...bool(false), key: `${prefix}burn_shards_epic`, label: 'Hero shards (epic)' },
    { ...bool(false), key: `${prefix}burn_shards_mythic`, label: 'Hero shards (mythic)' },
    { ...bool(false), key: `${prefix}burn_taming`, label: 'Taming marks' },
    { ...bool(false), key: `${prefix}burn_lucky`, label: 'Lucky chips' },
  ];
}
