    ...
    <section className="relative overflow-hidden py-24">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-muted">{t('features.subtitle')}</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          {CARDS.map((i, idx) => (
            <div
              key={i}
              className="glass glow-border card-hover fade-up group relative rounded-2xl p-8 transition-all duration-300 hover:border-glow/50"
