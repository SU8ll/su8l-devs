    ...
    <div style={{display:'flex', flexDirection:'column', gap:18}}>
      ...
      <section className="m-card" style={{display:'flex', alignItems:'center', gap:14, padding:18}}>
        ...
        <div style={{minWidth:0, flex:1}}>
          ...
          <div style={{marginTop:8}}><Badge tone="green">{t('dash.statusActive')}</Badge></div>
        </div>
      </section>
      ...
      <section>
        <div className="m-stats">
          <div className="m-stat">
            ...
            <div style={{marginTop:6, fontSize:10.5, fontWeight:600, letterSpacing:'0.08em', textTransform:'uppercase', color:'#6B6A78'}}>{t('dash.activeSubs')}</div>
          </div>
          <div className="m-stat">
            ...
            <div style={{marginTop:6, fontSize:10.5, fontWeight:600, letterSpacing:'0.08em', textTransform:'uppercase', color:'#6B6A78'}}>{t('dash.permanent')}</div>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        {data.subscriptions.length === 0 ? (
          <div className="m-card" style={{textAlign:'center', padding:'22px 16px'}}>
            ...
            <div style={{marginTop:8, fontWeight:700, color:'#F5F5F7'}}>{t('dash.noSub')}</div>
      ...
      {data.activeSubscriptions > 0 && (
        <section className="m-card" style={{padding:18}}>
          ...
          <div style={{marginTop:12, display:'flex', alignItems:'center', gap:8}}>
            ...
            <span style={{fontSize:12, color:'#6B6A78'}}>{t('checkout.oneTime')} · {t('dash.permanent')}</span>
          </div>
          {data.ownsExtraSlot ? (
      ...
      <section className="m-card" style={{padding:18}}>
        ...
        <Link to="/dashboard/referral" className="m-btn m-btn-ghost" style={{width:'100%', marginTop:14}}>{t('dash.referral')}</Link>
      </section>
